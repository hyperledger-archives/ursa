...
#[no_mangle]
pub extern fn hl_crypto_cl_tails_generator_next(rev_tails_generator: *const c_void,
                                                  tail_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_tails_generator_next: >>> rev_tails_generator: {:?}, tail_p {:?}",
    ...
    let res = match rev_tails_generator.next() {
        Ok(tail) => {
            unsafe {
                ...
                trace!("hl_crypto_cl_tails_generator_next: *tail_p: {:?}", *tail_p);
            }
            ErrorCode::Success
        }
    ...
    trace!("hl_crypto_cl_tails_generator_next: <<< {:?}", res);
    res
}

#[no_mangle]
pub extern fn hl_crypto_cl_tails_generator_count(rev_tails_generator: *const c_void,
                                                   count_p: *mut u32) -> ErrorCode {
    trace!("hl_crypto_cl_tails_generator_count: >>> rev_tails_generator: {:?}, count_p {:?}",
    ...
    unsafe {
        *count_p = cnt;
        trace!("hl_crypto_cl_tails_generator_count: *count_p: {:?}", *count_p);
    }
    let res = ErrorCode::Success;


    trace!("hl_crypto_cl_tails_generator_count: <<< {:?}", res);
    res
}

#[no_mangle]
pub extern fn hl_crypto_cl_tail_free(tail: *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_tail_free: >>> tail: {:?}", tail);

    check_useful_c_ptr!(tail, ErrorCode::CommonInvalidParam1);

    let tail = unsafe { Box::from_raw(tail as *mut Tail); };
    trace!("hl_crypto_cl_tail_free: entity: tail: {:?}", tail);

    let res = ErrorCode::Success;

    trace!("hl_crypto_cl_tail_free: <<< res: {:?}", res);
    res
}

#[no_mangle]
pub extern fn hl_crypto_cl_witness_new(rev_idx: u32,
                                         max_cred_num: u32,
    ...
    trace!("hl_crypto_cl_witness_new: >>> rev_idx: {:?}, max_cred_num {}, issuance_by_default {}, rev_reg_delta {:?}, ctx_tails {:?}, take_tail {:?}, \
        ...
        Ok(witness) => {
            unsafe {
                *witness_p = Box::into_raw(Box::new(witness)) as *const c_void;
                trace!("hl_crypto_cl_witness_new: *witness_p: {:?}", *witness_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("hl_crypto_cl_witness_new: <<< res: {:?}", res);
    res
}

#[no_mangle]
pub extern fn hl_crypto_cl_witness_update(rev_idx: u32,
                                            max_cred_num: u32,
                                            rev_reg_delta: *const c_void,
                                            witness: *mut c_void,
                                            ctx_tails: *const c_void,
    ...
    trace!("hl_crypto_cl_witness_update: >>> rev_idx: {:?}, max_cred_num {}, rev_reg_delta {:?}, ctx_tails {:?}, take_tail {:?}, put_tail {:?}, witness {:?}",
    ...
    trace!("hl_crypto_cl_witness_update: <<< res: {:?}", res);
    res
}

#[no_mangle]
pub extern fn hl_crypto_cl_witness_free(witness: *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_witness_free: >>> witness: {:?}", witness);

    check_useful_c_ptr!(witness, ErrorCode::CommonInvalidParam1);

    let witness = unsafe { Box::from_raw(witness as *mut Witness); };
    trace!("hl_crypto_cl_witness_free: entity: witness: {:?}", witness);

    let res = ErrorCode::Success;

    trace!("hl_crypto_cl_witness_free: <<< res: {:?}", res);
    res
}
...
/// calling hl_crypto_cl_credential_schema_builder_finalize.
///
/// # Arguments
/// * `credential_schema_builder_p` - Reference that will contain credentials attributes builder instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_credential_schema_builder_new(credential_schema_builder_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_credential_schema_builder_new: >>> credential_schema_builder_p: {:?}", credential_schema_builder_p);
    ...
    let res = match Issuer::new_credential_schema_builder() {
        Ok(credential_schema_builder) => {
            trace!("hl_crypto_cl_credential_schema_builder_new: credential_schema_builder: {:?}", credential_schema_builder);
            unsafe {
    ...
    trace!("hl_crypto_cl_credential_schema_builder_new: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_credential_schema_builder_add_attr(credential_schema_builder: *const c_void,
                                                                attr: *const c_char) -> ErrorCode {
    trace!("hl_crypto_cl_credential_schema_builder_add_attr: >>> credential_schema_builder: {:?}, attr: {:?}", credential_schema_builder, attr);
    ...
    trace!("hl_crypto_cl_credential_schema_builder_add_attr: entities: credential_schema_builder: {:?}, attr: {:?}", credential_schema_builder, attr);
    ...
    trace!("hl_crypto_cl_credential_schema_builder_add_attr: <<< res: {:?}", res);
    res
}
...
/// calling hl_crypto_cl_credential_schema_free.
///
/// # Arguments
/// * `credential_schema_builder` - Reference that contains credential schema builder instance pointer
/// * `credential_schema_p` - Reference that will contain credentials schema instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_credential_schema_builder_finalize(credential_schema_builder: *const c_void,
                                                                credential_schema_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_credential_schema_builder_finalize: >>> credential_schema_builder: {:?}, credential_schema_p: {:?}", credential_schema_builder, credential_schema_p);
    ...
    trace!("hl_crypto_cl_credential_schema_builder_finalize: entities: credential_schema_builder: {:?}", credential_schema_builder);

    let res = match credential_schema_builder.finalize() {
        Ok(credential_schema) => {
            trace!("hl_crypto_cl_credential_schema_builder_finalize: credential_schema: {:?}", credential_schema);
            unsafe {
                *credential_schema_p = Box::into_raw(Box::new(credential_schema)) as *const c_void;
                trace!("hl_crypto_cl_credential_schema_builder_finalize: *credential_schema_p: {:?}", *credential_schema_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("hl_crypto_cl_credential_schema_builder_finalize: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_credential_schema_free(credential_schema: *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_credential_schema_free: >>> credential_schema: {:?}", credential_schema);
    ...
    trace!("hl_crypto_cl_credential_schema_free: entity: credential_schema: {:?}", credential_schema);

    let res = ErrorCode::Success;

    trace!("hl_crypto_cl_credential_schema_free: <<< res: {:?}", res);
    res
}
...
/// calling hl_crypto_cl_non_credential_schema_builder_finalize.
///
/// # Arguments
/// * `credential_schema_builder_p` - Reference that will contain credentials attributes builder instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_non_credential_schema_builder_new(non_credential_schema_builder_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_non_credential_schema_builder_new: >>> non_credential_schema_builder_p: {:?}", non_credential_schema_builder_p);
    ...
    let res = match Issuer::new_non_credential_schema_builder() {
        Ok(non_credential_schema_builder) => {
            trace!("hl_crypto_cl_credential_schema_builder_new: non_credential_schema_builder: {:?}", non_credential_schema_builder);
            unsafe {
                *non_credential_schema_builder_p = Box::into_raw(Box::new(non_credential_schema_builder)) as *const c_void;
                trace!("hl_crypto_cl_credential_schema_builder_new: *credential_schema_builder_p: {:?}", *non_credential_schema_builder_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("hl_crypto_cl_non_credential_schema_builder_new: <<< res: {:?}", res);
    res
}
...
/// * `attr` - Attribute to add as null terminated string.
#[no_mangle]
pub extern fn hl_crypto_cl_non_credential_schema_builder_add_attr(non_credential_schema_builder: *const c_void,
                                                                    attr: *const c_char) -> ErrorCode {
    trace!("hl_crypto_cl_credential_schema_builder_add_attr: >>> non_credential_schema_builder: {:?}, attr: {:?}", non_credential_schema_builder, attr);

    check_useful_mut_c_reference!(non_credential_schema_builder, NonCredentialSchemaBuilder, ErrorCode::CommonInvalidParam1);
    check_useful_c_str!(attr, ErrorCode::CommonInvalidParam2);

    trace!("hl_crypto_cl_credential_schema_builder_add_attr: entities: credential_schema_builder: {:?}, attr: {:?}", non_credential_schema_builder, attr);
    ...
    trace!("hl_crypto_cl_non_credential_schema_builder_add_attr: <<< res: {:?}", res);
    res
}
...
/// calling hl_crypto_cl_non_credential_schema_free.
///
/// # Arguments
/// * `non_credential_schema_builder` - Reference that contains non credential schema builder instance pointer
/// * `non_credential_schema_p` - Reference that will contain non credentials schema instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_non_credential_schema_builder_finalize(non_credential_schema_builder: *const c_void,
                                                                    non_credential_schema_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_non_credential_schema_builder_finalize: >>> non_credential_schema_builder: {:?}, non_credential_schema_p: {:?}", non_credential_schema_builder, non_credential_schema_p);
    ...
    trace!("hl_crypto_cl_non_credential_schema_builder_finalize: entities: credential_schema_builder: {:?}", non_credential_schema_builder);

    let res = match non_credential_schema_builder.finalize() {
        Ok(non_credential_schema) => {
            trace!("hl_crypto_cl_non_credential_schema_builder_finalize: credential_schema: {:?}", non_credential_schema);
            unsafe {
                *non_credential_schema_p = Box::into_raw(Box::new(non_credential_schema)) as *const c_void;
                trace!("hl_crypto_cl_non_credential_schema_builder_finalize: *credential_schema_p: {:?}", *non_credential_schema_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("hl_crypto_cl_non_credential_schema_builder_finalize: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_non_credential_schema_free(non_credential_schema: *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_non_credential_schema_free: >>> non_credential_schema: {:?}", non_credential_schema);
    ...
    trace!("hl_crypto_cl_non_credential_schema_free: entity: credential_schema: {:?}", non_credential_schema);

    let res = ErrorCode::Success;

    trace!("hl_crypto_cl_non_credential_schema_free: <<< res: {:?}", res);
    res
}
...
/// calling hl_crypto_cl_credential_values_builder_finalize.
///
/// # Arguments
/// * `credential_values_builder_p` - Reference that will contain credentials values builder instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_credential_values_builder_new(credential_values_builder_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_credential_values_builder_new: >>> credential_values_builder_p: {:?}", credential_values_builder_p);
    ...
    let res = match Issuer::new_credential_values_builder() {
        Ok(credential_values_builder) => {
            trace!("hl_crypto_cl_credential_values_builder_new: credential_values_builder: {:?}", credential_values_builder);
            unsafe {
    ...
    trace!("hl_crypto_cl_credential_values_builder_new: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_credential_values_builder_add_dec_known(credential_values_builder: *const c_void,
                                                                 attr: *const c_char,
                                                                 dec_value: *const c_char) -> ErrorCode {
    trace!("hl_crypto_cl_credential_values_builder_add_dec_known: >>> credential_values_builder: {:?}, attr: {:?}, dec_value: {:?}",
    ...
    trace!("hl_crypto_cl_credential_values_builder_add_dec_known: entities: credential_values_builder: {:?}, attr: {:?}, dec_value: {:?}", credential_values_builder, attr, dec_value);
    ...
    trace!("hl_crypto_cl_credential_values_builder_add_dec_known: <<< res: {:?}", res);
    res
}
...
/// * `dec_value` - Credential attr dec_value. Decimal BigNum representation as null terminated string.
#[no_mangle]
pub extern fn hl_crypto_cl_credential_values_builder_add_dec_hidden(credential_values_builder: *const c_void,
                                                                      attr: *const c_char,
                                                                      dec_value: *const c_char) -> ErrorCode {
    trace!("hl_crypto_cl_credential_values_builder_add_dec_hidden: >>> credential_values_builder: {:?}, attr: {:?}, dec_value: {:?}",
           credential_values_builder, attr, dec_value);
    ...
    trace!("hl_crypto_cl_credential_values_builder_add_dec_hidden: entities: credential_values_builder: {:?}, attr: {:?}, dec_value: {:?}", credential_values_builder, attr, dec_value);
    ...
    trace!("hl_crypto_cl_credential_values_builder_add_dec_hidden: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_credential_values_builder_add_dec_commitment(credential_values_builder: *const c_void,
                                                                          attr: *const c_char,
                                                                          dec_value: *const c_char,
                                                                          dec_blinding_factor: *const c_char) -> ErrorCode {
    trace!("hl_crypto_cl_credential_values_builder_add_dec_commitment: >>> credential_values_builder: {:?}, attr: {:?}, dec_value: {:?}, dec_blinding_factor: {:?}",
    ...
    trace!("hl_crypto_cl_credential_values_builder_add_dec_commitment: entities: credential_values_builder: {:?}, attr: {:?}, dec_value: {:?}, dec_blinding_factor: {:?}", credential_values_builder, attr, dec_value, dec_blinding_factor);
    ...
    trace!("hl_crypto_cl_credential_values_builder_add_dec_commitment: <<< res: {:?}", res);
    res
}
...
/// calling hl_crypto_cl_credential_values_free.
///
/// # Arguments
...
#[no_mangle]
pub extern fn hl_crypto_cl_credential_values_builder_finalize(credential_values_builder: *const c_void,
                                                                credential_values_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_credential_values_builder_finalize: >>> credential_values_builder: {:?}, credential_values_p: {:?}", credential_values_builder, credential_values_p);
    ...
    trace!("hl_crypto_cl_credential_values_builder_finalize: entities: credential_values_builder: {:?}", credential_values_builder);

    let res = match credential_values_builder.finalize() {
        Ok(credential_values) => {
            trace!("hl_crypto_cl_credential_values_builder_finalize: credential_values: {:?}", credential_values);
            unsafe {
                *credential_values_p = Box::into_raw(Box::new(credential_values)) as *const c_void;
                trace!("hl_crypto_cl_credential_values_builder_finalize: *credential_values_p: {:?}", *credential_values_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("hl_crypto_cl_credential_values_builder_finalize: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_credential_values_free(credential_values: *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_credential_values_free: >>> credential_values: {:?}", credential_values);
    ...
    trace!("hl_crypto_cl_credential_values_free: entity: credential_values: {:?}", credential_values);

    let res = ErrorCode::Success;

    trace!("hl_crypto_cl_credential_values_free: <<< res: {:?}", res);
    res
}
...
/// calling hl_crypto_cl_sub_proof_request_builder_finalize.
///
/// # Arguments
/// * `sub_proof_request_builder_p` - Reference that will contain sub proof request builder instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_sub_proof_request_builder_new(sub_proof_request_builder_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_sub_proof_request_builder_new: >>> sub_proof_request_builder_p: {:?}", sub_proof_request_builder_p);
    ...
    let res = match Verifier::new_sub_proof_request_builder() {
        Ok(sub_proof_request_builder) => {
            trace!("hl_crypto_cl_sub_proof_request_builder_new: sub_proof_request_builder: {:?}", sub_proof_request_builder);
            unsafe {
    ...
    trace!("hl_crypto_cl_sub_proof_request_builder_new: <<< res: {:?}", res);
    res
}
...
/// * `attr` - Credential attr to add as null terminated string.
#[no_mangle]
pub extern fn hl_crypto_cl_sub_proof_request_builder_add_revealed_attr(sub_proof_request_builder: *const c_void,
                                                                         attr: *const c_char) -> ErrorCode {
    trace!("hl_crypto_cl_sub_proof_request_builder_add_revealed_attr: >>> sub_proof_request_builder: {:?}, attr: {:?}",
    ...
    trace!("hl_crypto_cl_sub_proof_request_builder_add_revealed_attr: entities: sub_proof_request_builder: {:?}, attr: {:?}",
           sub_proof_request_builder, attr);
    ...
    trace!("hl_crypto_cl_sub_proof_request_builder_add_revealed_attr: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_sub_proof_request_builder_add_predicate(sub_proof_request_builder: *const c_void,
                                                                     attr_name: *const c_char,
                                                                     p_type: *const c_char,
                                                                     value: i32) -> ErrorCode {
    trace!("hl_crypto_cl_sub_proof_request_builder_add_predicate: >>> sub_proof_request_builder: {:?}, attr_name: {:?}, p_type: {:?}, value: {:?}",
    ...
    trace!("hl_crypto_cl_sub_proof_request_builder_add_predicate: entities: >>> sub_proof_request_builder: {:?}, attr_name: {:?}, p_type: {:?}, value: {:?}",
           sub_proof_request_builder, attr_name, p_type, value);
    ...
    trace!("hl_crypto_cl_sub_proof_request_builder_add_predicate: <<< res: {:?}", res);
    res
}
...
/// calling hl_crypto_cl_sub_proof_request_free.
///
/// # Arguments
/// * `sub_proof_request_builder` - Reference that contains sub proof request builder instance pointer.
/// * `sub_proof_request_p` - Reference that will contain sub proof request instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_sub_proof_request_builder_finalize(sub_proof_request_builder: *const c_void,
                                                                sub_proof_request_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_sub_proof_request_builder_finalize: >>> sub_proof_request_builder: {:?}, sub_proof_request_p: {:?}",
    ...
    trace!("hl_crypto_cl_sub_proof_request_builder_finalize: entities: sub_proof_request_builder: {:?}", sub_proof_request_builder);

    let res = match sub_proof_request_builder.finalize() {
        Ok(sub_proof_request) => {
            trace!("hl_crypto_cl_sub_proof_request_builder_finalize: sub_proof_request: {:?}", sub_proof_request);
            unsafe {
                *sub_proof_request_p = Box::into_raw(Box::new(sub_proof_request)) as *const c_void;
                trace!("hl_crypto_cl_sub_proof_request_builder_finalize: *sub_proof_request_p: {:?}", *sub_proof_request_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("hl_crypto_cl_sub_proof_request_builder_finalize: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_sub_proof_request_free(sub_proof_request: *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_sub_proof_request_free: >>> sub_proof_request: {:?}", sub_proof_request);
    ...
    trace!("hl_crypto_cl_sub_proof_request_free: entity: sub_proof_request: {:?}", sub_proof_request);

    let res = ErrorCode::Success;

    trace!("hl_crypto_cl_sub_proof_request_free: <<< res: {:?}", res);
    res
}

/// Creates random nonce.
///
/// Note that nonce deallocation must be performed by calling hl_crypto_cl_nonce_free.
///
/// # Arguments
/// * `nonce_p` - Reference that will contain nonce instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_new_nonce(nonce_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_new_nonce: >>> {:?}", nonce_p);

    check_useful_c_ptr!(nonce_p, ErrorCode::CommonInvalidParam1);

    let res = match new_nonce() {
        Ok(nonce) => {
            trace!("hl_crypto_cl_new_nonce: nonce: {:?}", nonce);
            unsafe {
                *nonce_p = Box::into_raw(Box::new(nonce)) as *const c_void;
                trace!("hl_crypto_cl_new_nonce: *nonce_p: {:?}", *nonce_p);
            }
            ErrorCode::Success
        }
        Err(err) => err.to_error_code()
    ...
    trace!("hl_crypto_cl_new_nonce: <<< res: {:?}", res);
    res
}
...
#[no_mangle]
pub extern fn hl_crypto_cl_nonce_to_json(nonce: *const c_void,
                                           nonce_json_p: *mut *const c_char) -> ErrorCode {
    trace!("hl_crypto_cl_nonce_to_json: >>> nonce: {:?}, nonce_json_p: {:?}", nonce, nonce_json_p);
    ...
    trace!("hl_crypto_cl_nonce_to_json: entity >>> nonce: {:?}", nonce);

    let res = match serde_json::to_string(nonce) {
        Ok(nonce_json) => {
            trace!("hl_crypto_cl_nonce_to_json: nonce_json: {:?}", nonce_json);
            unsafe {
                let nonce_json = CTypesUtils::string_to_cstring(nonce_json);
                *nonce_json_p = nonce_json.into_raw();
                trace!("hl_crypto_cl_nonce_to_json: nonce_json_p: {:?}", *nonce_json_p);
            }
            ErrorCode::Success
        }
    ...
    trace!("hl_crypto_cl_nonce_to_json: <<< res: {:?}", res);
    res
}

/// Creates and returns nonce json.
///
/// Note: Nonce instance deallocation must be performed by calling hl_crypto_cl_nonce_free.
///
/// # Arguments
/// * `nonce_json` - Reference that contains nonce json.
/// * `nonce_p` - Reference that will contain nonce instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_nonce_from_json(nonce_json: *const c_char,
                                             nonce_p: *mut *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_nonce_from_json: >>> nonce_json: {:?}, nonce_p: {:?}", nonce_json, nonce_p);

    check_useful_c_str!(nonce_json, ErrorCode::CommonInvalidParam1);
    check_useful_c_ptr!(nonce_p, ErrorCode::CommonInvalidParam2);

    trace!("hl_crypto_cl_nonce_from_json: entity: nonce_json: {:?}", nonce_json);

    let res = match serde_json::from_str::<Nonce>(&nonce_json) {
        Ok(nonce) => {
            trace!("hl_crypto_cl_nonce_from_json: nonce: {:?}", nonce);
            unsafe {
                *nonce_p = Box::into_raw(Box::new(nonce)) as *const c_void;
                trace!("hl_crypto_cl_nonce_from_json: *nonce_p: {:?}", *nonce_p);
            }
            ErrorCode::Success
        }
    ...
    trace!("hl_crypto_cl_nonce_from_json: <<< res: {:?}", res);
    res
}
...
/// * `nonce` - Reference that contains nonce instance pointer.
#[no_mangle]
pub extern fn hl_crypto_cl_nonce_free(nonce: *const c_void) -> ErrorCode {
    trace!("hl_crypto_cl_nonce_free: >>> nonce: {:?}", nonce);

    check_useful_c_ptr!(nonce, ErrorCode::CommonInvalidParam1);

    let nonce = unsafe { Box::from_raw(nonce as *mut Nonce); };
    trace!("hl_crypto_cl_nonce_free: entity: nonce: {:?}", nonce);

    let res = ErrorCode::Success;

    trace!("hl_crypto_cl_nonce_free: <<< res: {:?}", res);
    res
}
...
mod tests {
    ...
    #[test]
    fn hl_crypto_cl_credential_schema_builder_new_works() {
        let mut credential_schema_builder: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_credential_schema_builder_new(&mut credential_schema_builder);
    ...
    #[test]
    fn hl_crypto_cl_non_credential_schema_builder_new_works() {
        let mut non_credential_schema_builder: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_non_credential_schema_builder_new(&mut non_credential_schema_builder);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_credential_schema_builder_add_attr_works() {
        let credential_schema_builder = _credential_schema_builder();

        let attr = CString::new("sex").unwrap();
        let err_code = hl_crypto_cl_credential_schema_builder_add_attr(credential_schema_builder, attr.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!credential_schema_builder.is_null());
    ...
    #[test]
    fn hl_crypto_cl_non_credential_schema_builder_add_attr_works() {
        let non_credential_schema_builder = _non_credential_schema_builder();

        let attr = CString::new("sex").unwrap();
        let err_code = hl_crypto_cl_non_credential_schema_builder_add_attr(non_credential_schema_builder, attr.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!non_credential_schema_builder.is_null());
    ...
    #[test]
    fn hl_crypto_cl_credential_schema_builder_finalize_works() {
        let credential_schema_builder = _credential_schema_builder();
        ...
        hl_crypto_cl_credential_schema_builder_finalize(credential_schema_builder, &mut credential_schema);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_non_credential_schema_builder_finalize_works() {
        let non_credential_schema_builder = _non_credential_schema_builder();
        ...
        hl_crypto_cl_non_credential_schema_builder_finalize(non_credential_schema_builder, &mut non_credential_schema);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_credential_schema_free_works() {
        let credential_schema = _credential_schema();

        let err_code = hl_crypto_cl_credential_schema_free(credential_schema);
        assert_eq!(err_code, ErrorCode::Success);
    }

    #[test]
    fn hl_crypto_cl_non_credential_schema_free_works() {
        let non_credential_schema = _non_credential_schema();

        let err_code = hl_crypto_cl_non_credential_schema_free(non_credential_schema);
        assert_eq!(err_code, ErrorCode::Success);
    }

    #[test]
    fn hl_crypto_cl_credential_values_builder_new_works() {
        let mut credential_values_builder: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_credential_values_builder_new(&mut credential_values_builder);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_credential_values_builder_add_dec_known_works() {
        ...
        let err_code = hl_crypto_cl_credential_values_builder_add_dec_known(credential_values_builder, attr.as_ptr(), dec_value.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!credential_values_builder.is_null());
    ...
    #[test]
    fn hl_crypto_cl_credential_values_builder_add_dec_hidden_works() {
        let credential_values_builder = _credential_values_builder();

        let attr = CString::new("master_secret").unwrap();
        let dec_value = CString::new("").unwrap();
        let err_code = hl_crypto_cl_credential_values_builder_add_dec_hidden(credential_values_builder, attr.as_ptr(), dec_value.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!credential_values_builder.is_null());
    ...
    #[test]
    fn hl_crypto_cl_credential_values_builder_add_dec_commitment_works() {
        let credential_values_builder = _credential_values_builder();
        ...
        let err_code = hl_crypto_cl_credential_values_builder_add_dec_commitment(credential_values_builder, attr.as_ptr(), dec_value.as_ptr(), dec_blinding_factor.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!credential_values_builder.is_null());
    ...
    #[test]
    fn hl_crypto_cl_credential_values_free_works() {
        let credential_values = _credential_values();

        let err_code = hl_crypto_cl_credential_values_free(credential_values);
        assert_eq!(err_code, ErrorCode::Success);
    }

    #[test]
    fn hl_crypto_cl_sub_proof_request_builder_new_works() {
        let mut sub_proof_request_builder: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_sub_proof_request_builder_new(&mut sub_proof_request_builder);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_sub_proof_request_builder_add_revealed_attr_works() {
        let sub_proof_request_builder = _sub_proof_request_builder();

        let attr = CString::new("sex").unwrap();
        let err_code = hl_crypto_cl_sub_proof_request_builder_add_revealed_attr(sub_proof_request_builder, attr.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!sub_proof_request_builder.is_null());
    ...
    #[test]
    fn hl_crypto_cl_sub_proof_request_builder_add_predicate_works() {
        let sub_proof_request_builder = _sub_proof_request_builder();
        ...
        let err_code = hl_crypto_cl_sub_proof_request_builder_add_predicate(sub_proof_request_builder, attr_name.as_ptr(), p_type.as_ptr(), value);
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!sub_proof_request_builder.is_null());
    ...
    #[test]
    fn hl_crypto_cl_sub_proof_request_builder_finalize_works() {
        let sub_proof_request_builder = _sub_proof_request_builder();
        ...
        hl_crypto_cl_sub_proof_request_builder_finalize(sub_proof_request_builder, &mut sub_proof_request);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_sub_proof_request_free_works() {
        let sub_proof_request = _sub_proof_request();

        let err_code = hl_crypto_cl_sub_proof_request_free(sub_proof_request);
        assert_eq!(err_code, ErrorCode::Success);
    }

    #[test]
    fn hl_crypto_cl_new_nonce_works() {
        let mut nonce_p: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_new_nonce(&mut nonce_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_nonce_to_json_works() {
        let nonce = _nonce();

        let mut nonce_json_p: *const c_char = ptr::null();
        let err_code = hl_crypto_cl_nonce_to_json(nonce, &mut nonce_json_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_nonce_from_json_works() {
        let nonce = _nonce();
        ...
        let mut nonce_p: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_nonce_from_json(nonce_json_p, &mut nonce_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    #[test]
    fn hl_crypto_cl_nonce_free_works() {
        let nonce = _nonce();

        let err_code = hl_crypto_cl_nonce_free(nonce);
        assert_eq!(err_code, ErrorCode::Success);
    }
}
...
pub mod mocks {
    ...
    pub fn _free_credential_schema_builder(credential_schema_builder: *const c_void) {
        let mut credential_schema: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_credential_schema_builder_finalize(credential_schema_builder, &mut credential_schema);
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!credential_schema.is_null());
    ...
    pub fn _free_non_credential_schema_builder(non_credential_schema_builder: *const c_void) {
        let mut non_credential_schema: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_credential_schema_builder_finalize(non_credential_schema_builder, &mut non_credential_schema);
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!non_credential_schema.is_null());
    ...
    pub fn _credential_schema() -> *const c_void {
        ...
        hl_crypto_cl_credential_schema_builder_finalize(credential_schema_builder, &mut credential_schema_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    pub fn _non_credential_schema() -> *const c_void {
        ...
        hl_crypto_cl_non_credential_schema_builder_finalize(non_credential_schema_builder, &mut non_credential_schema_p);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    pub fn _free_credential_values_builder(credential_values_builder: *const c_void) {
        ...
        let err_code = hl_crypto_cl_credential_values_builder_finalize(credential_values_builder, &mut credential_values);
        assert_eq!(err_code, ErrorCode::Success);
    ...
    pub fn _credential_values() -> *const c_void {
        ...
        let attr = CString::new("master_secret").unwrap();
        let dec_value = CString::new("").unwrap();
        let err_code = hl_crypto_cl_credential_values_builder_add_dec_hidden(credential_values_builder,
                                                                               attr.as_ptr(),
                                                                               dec_value.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!credential_values_builder.is_null());
        ...
        let err_code = hl_crypto_cl_credential_values_builder_add_dec_known(credential_values_builder,
                                                                          attr.as_ptr(),
                                                                          dec_value.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!credential_values_builder.is_null());
        ...
        let mut credential_values: *const c_void = ptr::null();
        hl_crypto_cl_credential_values_builder_finalize(credential_values_builder, &mut credential_values);
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!credential_values.is_null());
    ...
    pub fn _free_sub_proof_request_builder(sub_proof_request_builder: *const c_void) {
        let mut sub_proof_request: *const c_void = ptr::null();
        let err_code = hl_crypto_cl_sub_proof_request_builder_finalize(sub_proof_request_builder, &mut sub_proof_request);
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!sub_proof_request.is_null());
    ...
    pub fn _sub_proof_request() -> *const c_void {
        ...
        let err_code = hl_crypto_cl_sub_proof_request_builder_add_revealed_attr(sub_proof_request_builder, revealed_attr.as_ptr());
        assert_eq!(err_code, ErrorCode::Success);
        assert!(!sub_proof_request_builder.is_null());
    ...
    pub fn _witness(rev_reg_delta: *const c_void, get_storage_ctx: *const c_void) -> *const c_void {
        ...
        let err_code = hl_crypto_cl_witness_new(rev_idx,
                                                  max_cred_num,
                                                  false,
                                                  rev_reg_delta,
                                                  get_storage_ctx,
    ...
    pub fn _free_witness(witness: *const c_void) {
        let err_code = hl_crypto_cl_witness_free(witness);
        assert_eq!(err_code, ErrorCode::Success);
    }
    ...
    impl FFISimpleTailStorage {
        pub fn new(rev_tails_generator: *const c_void) -> Self {
            ...
            let mut cnt = 0u32;
            let res = hl_crypto_cl_tails_generator_count(rev_tails_generator, &mut cnt);
            assert_eq!(res, ErrorCode::Success);
            for _ in 0..cnt {
                let mut tail = ptr::null();
                let res = hl_crypto_cl_tails_generator_next(rev_tails_generator, &mut tail);
                assert_eq!(res, ErrorCode::Success);
                tails.push(tail);
            }
            Self {
