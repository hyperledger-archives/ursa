...
wasm-bindgen target/wasm32-unknown-unknown/release/hl_crypto.wasm --nodejs \
--out-dir $PKG_DIR/node
wasm-bindgen target/wasm32-unknown-unknown/release/hl_crypto.wasm --out-dir $PKG_DIR/module
