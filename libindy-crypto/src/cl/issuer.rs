...
impl Issuer {
    ...
    fn _new_credential_key_correctness_proof(cred_pr_pub_key: &CredentialPrimaryPublicKey,
        ...
        let mut xr_cap: HashMap<String, BigNumber> = HashMap::new();
        ...
        let key_correctness_proof = CredentialKeyCorrectnessProof { c, attrs, xz_cap, xr_cap };
...
mod tests {
    ...
    fn issuer_new_credential_def_works() {
        ...
        let (pub_key, priv_key, mut key_correctness_proof) = Issuer::new_credential_def(&mocks::credential_schema(), true).unwrap();
        key_correctness_proof.attrs.sort();
    ...
    fn issuer_new_credential_def_works_without_revocation_part() {
        ...
        let (pub_key, priv_key, mut key_correctness_proof) = Issuer::new_credential_def(&mocks::credential_schema(), false).unwrap();
        key_correctness_proof.attrs.sort();
        assert_eq!(pub_key.p_key, mocks::credential_primary_public_key());
        assert_eq!(priv_key.p_key, mocks::credential_primary_private_key());
        assert_eq!(key_correctness_proof, mocks::credential_key_correctness_proof());
...
pub mod mocks {
    ...
    pub fn credential_key_correctness_proof() -> CredentialKeyCorrectnessProof {
        let mut xr_cap = HashMap::new();
        xr_cap.insert("age".to_string(), BigNumber::from_dec("").unwrap());
        xr_cap.insert("height".to_string(), BigNumber::from_dec("").unwrap());
        xr_cap.insert("name".to_string(), BigNumber::from_dec("").unwrap());
        xr_cap.insert("sex".to_string(), BigNumber::from_dec("").unwrap());
        CredentialKeyCorrectnessProof {
            c: BigNumber::from_dec("115685480134110563659502023918400734311361769059518507192058954879522711620032").unwrap(),
            attrs: vec!["age".to_owned(), "height".to_owned(), "name".to_owned(), "sex".to_owned()],
    ...
    pub fn signature_correctness_proof() -> SignatureCorrectnessProof {
        SignatureCorrectnessProof {
            se: BigNumber::from_dec("").unwrap(),
            c: BigNumber::from_dec("60095275843228327670322647205062897410576352902420719264327617072867950892027").unwrap(),
        }
    }
