...
impl Issuer {
    ...
    /// ```
    pub fn sign_claim<RTA>(prover_id: &str,
                           ...
                           -> Result<(ClaimSignature, SignatureCorrectnessProof, Option<RevocationRegistryDelta>), IndyCryptoError> where RTA: RevocationTailsAccessor {
        ...
        let (r_claim, new_r_reg_delta) =
            if let (Some(rev_idx_2), Some(max_cred_n), Some(ref mut r_reg), Some(r_key_priv)) = (rev_idx,
                                                                                                 max_cred_num,
                                                                                                 rev_reg,
                                                                                                 rev_key_priv) {
    ...
    fn _new_non_revocation_claim<RTA>(rev_idx: u32,
                                      claim_context: &BigNumber,
                                      blinded_ms: &BlindedMasterSecret,
                                      ...
                                      rev_tails_accessor: RTA)
                                      -> Result<(NonRevocationClaimSignature, RevocationRegistryDelta), IndyCryptoError> where RTA: RevocationTailsAccessor {
        ...
        let r_priv_key: &IssuerRevocationPrivateKey = cred_priv_key.r_key
            .as_ref()
...
//        let (_, _) = Issuer::new_revocation_registry_def(&pub_key, 100).unwrap();
//    }
//
//    #[test]
...
//    }
//
//    pub fn accumulator_pub_key() -> RevocationKeyPublic {
//        RevocationKeyPublic {
...
//    }
//
//    pub fn revocation_reg_public() -> RevocationRegistryDefPublic {
//        RevocationRegistryDefPublic {
