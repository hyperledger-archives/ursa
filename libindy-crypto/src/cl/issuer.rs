...
impl Issuer {
    ...
    fn _new_primary_keys(claim_schema: &ClaimSchema) -> Result<(IssuerPrimaryPublicKey,
        ...
        let issuer_pr_pub_key = IssuerPrimaryPublicKey { n, s, rms, r, z };
    ...
    fn _new_primary_claim(claim_context: &BigNumber,
        ...
        let pr_claim_signature = PrimaryClaimSignature { m_2: claim_context.clone()?, a, e, v, claim_values: clone_bignum_map(&claim_values.attrs_values)? };
    ...
    fn _sign_primary_claim(p_pub_key: &IssuerPublicKey,
        ...
        let mut rx = p_pub_key.s
            ...
            .mod_mul(&blnd_ms.u, &p_pub_key.n, Some(&mut context))?;
...
mod tests {
    ...
    fn sign_primary_claim_works() {
        ...
        let expected_signature = BigNumber::from_dec("").unwrap();
        let expected_q = BigNumber::from_dec("").unwrap();
...
pub mod mocks {
    ...
    pub fn issuer_primary_public_key() -> IssuerPrimaryPublicKey {
        ...
        IssuerPrimaryPublicKey { n, s, rms, r, z }
    }
    ...
    pub fn primary_claim() -> PrimaryClaimSignature {
        ...
        claim_values: claim_values.attrs_values,
...
pub fn signature_correctness_proof() -> SignatureCorrectnessProof {
    SignatureCorrectnessProof {
        se: BigNumber::from_dec("").unwrap(),
        c: BigNumber::from_dec("113586107527300269613690636778101356384975647250156295287050549744584072418933").unwrap(),
    }
}
