...
pub extern fn indy_crypto_cl_issuer_sign_credential_with_revoc(prover_id: *const c_char,
    ...
    trace!("indy_crypto_cl_issuer_sign_credential: >>> prover_id: {:?}, blinded_master_secret: {:?}, blinded_master_secret_correctness_proof: {:?}, master_secret_blinding_nonce: {:?}, \
...
///
/// # Arguments
/// * `revocation_registry_delta` - Reference that contains revocation egistry delta instance pointer.
#[no_mangle]
...
/// Revokes a credential by a revoc_id in a given revocation registry.
///
/// # Arguments
